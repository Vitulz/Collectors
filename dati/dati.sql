...
insert into
    collezione (ID, nome, visibilita, ID_collezionista)
values
...
insert into
    traccia (ID, titolo, durata, ID_disco)
values
...
insert into
    artista (ID, nomeArte, biografia)
values
    (
        1,
        'Nayt',
        'Nayt, pseudonimo di William Mezzanotte, è un rapper italiano nato a Isernia, classe ’94. Cresce a Roma dove sin da giovanissimo comincia a far circolare il suo nome: il primo singolo No Story viene pubblicato a febbraio 2011, con strumentale di 3D.'
    ),
    (2, '3D', null),
    (
        3,
        'Tedua',
        'Il vero nome di Tedua è Mario Molinari. Nato a Genova il 21 febbraio 1994 sotto il segno dei Pesci.'
    ),
...
insert into
    condivisa (ID_collezione, ID_collezionista)
values
    (2, 4),
    (3, 2),
    (3, 3);
...
insert into
    autore (ID_disco, ID_artista, nomeRuolo)
values
    (1, 1, 'Cantante'),
    (1, 2, 'Produttore'),
    (2, 3, 'Cantante'),
...
insert into
    collaborazione (ID_traccia, ID_artista, nomeRuolo)
values
    (10, 6, 'Cantante');